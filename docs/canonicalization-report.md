...
[`i18n/`](../i18n/) (generated by `scripts/extract_subjects.py`). The Latin file is
complete (5,875 subjects: honorific from the sanctity marker of the 2004 text,
suppressed for feasts, pluralized for pairs and groups; name from the slug; deprecated
IDs from their historical-edition extraction). The Italian (4,047) and English (2,943)
files are partial mechanical extractions from the 2004-edition texts, kept only when
verified against the slug, and await translator completion. Subject and slug are
