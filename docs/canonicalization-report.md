...
like conversio-sancti-pauli); **genuinely anonymous** groups follow rule 8, number +
...
[`i18n/`](../i18n/) (generated by `scripts/extract_subjects.py`). All locale files carry the identical complete key set (all 5,858 IDs), with empty
